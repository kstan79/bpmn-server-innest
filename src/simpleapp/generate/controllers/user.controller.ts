...
//import * as userapischema from '../apischemas/user.apischema';
...
const doctype = 'user'.toUpperCase();
@ApiTags(doctype)
@Controller(doctype.toLowerCase())
export class UserController extends SimpleAppAbstractController<
  UserService,  
  schemas.User,
  types.User> {
