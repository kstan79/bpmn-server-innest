...
// import * as custtype from '../types/cust.type';
import * as types from '../types';
import * as schemas from '../apischemas';
//import * as custapischema from '../apischemas/cust.apischema';
...
const doctype = 'cust'.toUpperCase();
@ApiTags(doctype)
@Controller(doctype.toLowerCase())
export class CustomerController extends SimpleAppAbstractController<
  CustomerService,  
  schemas.Customer,
  types.Customer> {
  ...
  @Get()
    @Roles(Role.SuperAdmin,Role.SuperUser,Role.Customer_search)
    @HttpCode(200)
  @ApiResponse({
    status: 200,
    description: 'Found',
  ...
  @Post()
    @Roles(Role.SuperAdmin,Role.SuperUser,Role.Customer_create)
  ...
  @ApiResponse({ status: 500, description: 'internal error' })
  @ApiBody({ description: 'Data',type:schemas.Customer })
  @ApiOperation({ operationId: 'runCreate' })
  async create(@AppUser() appuser: UserContext,@Body() data: schemas.Customer) {    
...
/***************************** end status control api definitions *****************************************/
  ...
  @ApiResponse({
    ...
    @Roles(Role.SuperAdmin,Role.SuperUser,Role.Customer_update)
    
  @ApiResponse({ status: 404, description: 'Document not found' })
  @ApiResponse({ status: 500, description: 'Internal error' })
  @ApiBody({ description: 'Data',type: schemas.Customer })
  @ApiOperation({ operationId: 'runUpdate' })
  async update(@AppUser() appuser: UserContext,@Param('id') id: string, @Body() data: schemas.Customer) {    
  ...
  async patch(@AppUser() appuser: UserContext,@Param('id') id: string, @Body() data: schemas.Customer) {    
    return await this._patch(appuser,id, data) ;
  }

  @Delete(':id')
    @Roles(Role.SuperAdmin,Role.SuperUser,Role.Customer_delete)
