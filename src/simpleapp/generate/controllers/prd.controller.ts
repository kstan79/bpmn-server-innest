...
/***************************** end status control api definitions *****************************************/
  ...
  async update(@AppUser() appuser: UserContext,@Param('id') id: string, @Body() data: schemas.Product) {    
  ...
  async patch(@AppUser() appuser: UserContext,@Param('id') id: string, @Body() data: schemas.Product) {    
