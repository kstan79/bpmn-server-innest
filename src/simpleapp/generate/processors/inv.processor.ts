...
import {
  DefaultInvoiceCustomer,
  DefaultInvoiceDetailsProduct,
  DefaultInvoiceDetails,
  DefaultInvoiceDocNoFormat,
  DefaultInvoice,
} from '../defaults/inv.default';
...
export class InvoiceProcessor extends SimpleAppService<Invoice> {
  ...
  reCalculateValue(data: Invoice) {
    ...
    jsopbj.apply(data, '$.details[*]', function (value: any) {
      return sharelibs.getSubtotal(value);
    });
    ...
    jsopbj.apply(data, '$.invoiceTotal', function (value: any) {
      return sharelibs.getTotal(data.details);
    });
  }
